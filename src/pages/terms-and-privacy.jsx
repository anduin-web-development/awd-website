    ...
    <div>
      ...
      <Section>
        ...
        <div className="content">
          ...
          <p>
            By accessing the website at&nbsp; http://anduin.io, you are agreeing
          ...
          <ol type="a">
            <li>
              ...
              materials (information or software) on Anduin Web Development's
            ...
            <li>
              ...
              these restrictions and may be terminated by Anduin Web Development
          ...
          <ol type="a">
            <li>
              The materials on Anduin Web Development's website are provided on
              an 'as is' basis. Anduin Web Development makes no warranties,
          ...
          <p>
            In no event shall Anduin Web Development or its suppliers be liable
            ...
            use or inability to use the materials on Anduin Web Development's
            website, even if Anduin Web Development or a Anduin Web Development
          ...
          <p>
            ...
            include technical, typographical, or photographic errors. Anduin Web
            Development does not warrant that any of the materials on its
            website are accurate, complete or current. Anduin Web Development
            may make changes to the materials contained on its website at any
            time without notice. However Anduin Web Development does not make
            any commitment to update the materials.
          </p>
          <h3 className="title is-3">6. Links</h3>
          <p>
            Anduin Web Development has not reviewed all of the sites linked to
            ...
            Anduin Web Development of the site. Use of any such linked website
      ...
      <Section>
        ...
        <div className="content">
          ...
          <p>
            We do not request your personal information except where necessary.
            When we do collect personal information, we do so by fair and lawful
            means with your knowledge or consent, and collect no more than what
            is necessary in the fulfillment of a service. We will inform you of
            the reason for collection, and how your information will be used.
          </p>
          <p>
            We do not share your personal information with third-parties, except
            where required by law. We will only retain personal information for
            as long as is necessary in the provision of a service.
          </p>
          <p>
            We do not store your personal information on our servers unless it
            is requisite to the provision of a service. What we store, we will
            protect, within commercially acceptable means, from loss or theft,
